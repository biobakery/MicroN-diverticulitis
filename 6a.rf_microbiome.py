...
plt.savefig(r'/Users/wm897/Dropbox (Partners HealthCare)/MGH/AC/AC/diverticulitis/NHS2/MicroN/mbx/results/rf/roc_microbiome_no_label.png',dpi=300)


#PLOT MEAN INPORTANCE OF TOP 20 SPECIES ACROSS
##plot importance
#how many bacteria to plot
##num_bact=20
##mean_importance = mean_importance/mean_importance.max()
##sorted_idx=numpy.argsort(mean_importance)
##print(sorted_idx)
##barPos=numpy.arange(sorted_idx[len(sorted_idx)-num_bact:len(sorted_idx)].shape[0])
##plot.barh(barPos, mean_importance[sorted_idx[len(sorted_idx)-num_bact:len(sorted_idx)]], align='center')
##plot.yticks(barPos, X1.columns[sorted_idx[len(sorted_idx)-num_bact:len(sorted_idx)]])
##plot.xlabel('Variable Importance')
###plot.show()
##plt.savefig(r'/Users/wm897/Dropbox (Partners HealthCare)/MGH/AC/AC/diverticulitis/NHS2/MicroN/mbx/results/rf/roc_microbiome_importance_new.png',dpi=300)
##
...
indices = np.argsort(mean_importance)[-20:]
plt.barh(X1.columns[indices], mean_importance[indices])
